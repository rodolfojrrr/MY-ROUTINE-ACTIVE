...
title Studium SI - Assinatura Android fixa
cd /d "%~dp0"
...
keytool -genkeypair -v -keystore "%KEYSTORE%" -storepass "%PASS%" -keypass "%PASS%" -alias "%ALIAS%" -keyalg RSA -keysize 4096 -validity 10000 -dname "CN=Studium SI, OU=Personal, O=Rodolfo Junior, L=Local, ST=Local, C=BR"
